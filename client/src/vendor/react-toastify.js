...
import e, { isValidElement as t, useRef as n, useLayoutEffect as o, useEffect as s, cloneElement as a, useSyncExternalStore as r2, useState as i } from "/__vendor__/react.js";
...
function g(t2) {
  ...
  return function(t3) {
    ...
    const h2 = i2 ? `${a2}--${u2}` : a2, T2 = i2 ? `${r3}--${u2}` : r3, E2 = n(0);
    return o(() => {
...
function L(e2) {
  const { subscribe: o2, getSnapshot: s2, setProps: i2 } = n(function(e3) {
    ...
    return { subscribe(o3) {
      const s3 = /* @__PURE__ */ function(e4, n3, o4) {
        ...
        const v2 = /* @__PURE__ */ new Map(), h2 = /* @__PURE__ */ new Set(), T2 = () => {
          ...
          e5.staleId && v2.delete(e5.staleId), v2.set(n4, e5), l2 = [...l2, e5.props.toastId].filter((t2) => t2 !== e5.staleId), T2(), o4(y(e5, i4 ? "added" : "updated")), i4 && u(s5) && s5(t(r5) && r5.props);
        };
        return { id: e4, props: g2, observe: (e5) => (h2.add(e5), () => h2.delete(e5)), toggle: (e5, t2) => {
          ...
          const $2 = { ...g2, style: g2.toastStyle, key: s4++, ...Object.fromEntries(Object.entries(l3).filter((e5) => {
            ...
            u(n5) && n5(t(s5) && s5.props), o4(y(e5, "removed")), v2.delete(f3), r4--, r4 < 0 && (r4 = 0), i3.length > 0 ? b2(i3.shift()) : T2();
          } };
          var w2, k2;
          ...
          let P2 = n4;
          t(n4) && !d(n4.type) ? P2 = a(n4, { closeToast: L2, toastProps: $2, data: I2 }) : u(n4) && (P2 = n4({ closeToast: L2, toastProps: $2, data: I2 }));
...
function N(e2) {
  const [t2, o2] = i(false), [a2, r3] = i(false), l = n(null), c2 = n({ start: 0, delta: 0, removalDistance: 0, canCloseOnClick: true, canDrag: false, didMove: false }).current, { autoClose: d2, pauseOnHover: u2, closeToast: p2, onClick: m2, closeOnClick: f2 } = e2;
  var g2, y2;
  function h2() {
    o2(true);
  }
  ...
  null == (y2 = v.get((g2 = { id: e2.toastId, containerId: e2.containerId, fn: o2 }).containerId || 1)) || y2.setToggle(g2.id, g2.fn), s(() => {
...
function $(t2) {
  ...
  return e.createElement("div", { className: "Toastify__progress-bar--wrp", "data-hidden": y2 }, e.createElement("div", { className: `Toastify__progress-bar--bg Toastify__progress-bar-theme--${g2} Toastify__progress-bar--${a2}` }), e.createElement("div", { role: "progressbar", "aria-hidden": y2 ? "true" : "false", "aria-label": "notification timer", className: T2, style: v2, ...E2 }));
}
var w = 1;
var k = () => "" + w++;
function P(e2) {
...
var O = "undefined" != typeof window ? o : s;
var D = (t2) => {
  let { theme: n2, type: o2, isLoading: s2, ...a2 } = t2;
  return e.createElement("svg", { viewBox: "0 0 24 24", width: "100%", height: "100%", fill: "colored" === n2 ? "currentColor" : `var(--toastify-icon-color-${o2})`, ...a2 });
};
var z = { info: function(t2) {
  return e.createElement(D, { ...t2 }, e.createElement("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
}, warning: function(t2) {
  return e.createElement(D, { ...t2 }, e.createElement("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
}, success: function(t2) {
  return e.createElement(D, { ...t2 }, e.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}, error: function(t2) {
  return e.createElement(D, { ...t2 }, e.createElement("path", { d: "M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z" }));
}, spinner: function() {
...
var R = (n2) => {
  const { isRunning: o2, preventExitTransition: s2, toastRef: r3, eventHandlers: i2, playToast: c2 } = N(n2), { closeButton: d2, children: p2, autoClose: m2, onClick: f2, type: g2, hideProgressBar: y2, closeToast: v2, transition: h2, position: T2, className: E2, style: b2, bodyClassName: I2, bodyStyle: _2, progressClassName: C2, progressStyle: L2, updateId: w2, role: k2, progress: P2, rtl: M2, toastId: x2, deleteToast: A2, isIn: B2, isLoading: O2, closeOnClick: D2, theme: R2 } = n2, S2 = clsx_default("Toastify__toast", `Toastify__toast-theme--${R2}`, `Toastify__toast--${g2}`, { "Toastify__toast--rtl": M2 }, { "Toastify__toast--close-on-click": D2 }), H2 = u(E2) ? E2({ rtl: M2, position: T2, type: g2, defaultClassName: S2 }) : clsx_default(S2, E2), F2 = function(e2) {
    ...
    return false === r4 || (u(r4) ? i3 = r4({ ...l, isLoading: s3 }) : t(r4) ? i3 = a(r4, l) : s3 ? i3 = z.spinner() : ((e3) => e3 in z)(o3) && (i3 = z[o3](l))), i3;
  }(n2), X2 = !!P2 || !m2, Y2 = { closeToast: v2, type: g2, theme: R2 };
  let q2 = null;
  return false === d2 || (q2 = u(d2) ? d2(Y2) : t(d2) ? a(d2, Y2) : function(t2) {
    let { closeToast: n3, theme: o3, ariaLabel: s3 = "close" } = t2;
    return e.createElement("button", { className: `Toastify__close-button Toastify__close-button--${o3}`, type: "button", onClick: (e2) => {
      e2.stopPropagation(), n3(e2);
    }, "aria-label": s3 }, e.createElement("svg", { "aria-hidden": "true", viewBox: "0 0 14 16" }, e.createElement("path", { fillRule: "evenodd", d: "M7.71 8.23l3.75 3.75-1.48 1.48-3.75-3.75-3.75 3.75L1 11.98l3.75-3.75L1 4.48 2.48 3l3.75 3.75L9.98 3l1.48 1.48-3.75 3.75z" })));
  }(Y2)), e.createElement(h2, { isIn: B2, done: A2, position: T2, preventExitTransition: s2, nodeRef: r3, playToast: c2 }, e.createElement("div", { id: x2, onClick: f2, "data-in": B2, className: H2, ...i2, style: b2, ref: r3 }, e.createElement("div", { ...B2 && { role: k2 }, className: u(I2) ? I2({ type: g2 }) : clsx_default("Toastify__toast-body", I2), style: _2 }, null != F2 && e.createElement("div", { className: clsx_default("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !O2 }) }, F2), e.createElement("div", null, p2)), q2, e.createElement($, { ...w2 && !X2 ? { key: `pb-${w2}` } : {}, rtl: M2, theme: R2, delay: m2, isRunning: o2, isIn: B2, closeToast: v2, hide: y2, type: g2, style: L2, className: C2, controlledProgress: X2, progress: P2 || 0 })));
};
...
function Q(t2) {
  let o2 = { ...q, ...t2 };
  const s2 = t2.stacked, [a2, r3] = i(true), c2 = n(null), { getToastToRender: d2, isToastActive: m2, count: f2 } = L(o2), { className: g2, style: y2, rtl: v2, containerId: h2 } = o2;
  function T2(e2) {
  ...
  }, [a2, f2, s2]), e.createElement("div", { ref: c2, className: "Toastify", id: h2, onMouseEnter: () => {
    s2 && (r3(false), B.pause());
  }, onMouseLeave: E2 }, d2((t3, n2) => {
    const o3 = n2.length ? { ...y2 } : { ...y2, pointerEvents: "none" };
    return e.createElement("div", { className: T2(t3), style: o3, key: `container-${t3}` }, n2.map((t4) => {
      let { content: n3, props: o4 } = t4;
      return e.createElement(R, { ...o4, stacked: s2, collapseAll: E2, isIn: m2(o4.toastId, o4.containerId), style: o4.style, key: `toast-${o4.key}` }, n3);
    }));
  }));
}
export {
